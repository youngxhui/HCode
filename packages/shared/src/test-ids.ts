...
/** 自定义供应商表单：供应商目录下拉触发器 */
export const TID_MODEL_PROVIDER_CUSTOM_CATALOG_TRIGGER = "model-provider-custom-catalog-trigger";
/** 自定义供应商表单：供应商目录下拉项（动态后缀为目录条目 id） */
export const TID_MODEL_PROVIDER_CUSTOM_CATALOG_ITEM = "model-provider-custom-catalog-item";
/** 自定义供应商表单：供应商目录搜索框 */
export const TID_MODEL_PROVIDER_CUSTOM_CATALOG_SEARCH = "model-provider-custom-catalog-search";
/** 自定义供应商表单：自动拉取模型按钮 */
export const TID_MODEL_PROVIDER_CUSTOM_FETCH_MODELS_BUTTON =
  "model-provider-custom-fetch-models-button";
/** 自定义供应商表单：拉取结果模型勾选项（动态后缀为模型 id） */
export const TID_MODEL_PROVIDER_CUSTOM_FETCHED_MODEL_ITEM =
  "model-provider-custom-fetched-model-item";
/** 自定义供应商表单：确认创建按钮 */
export const TID_MODEL_PROVIDER_CUSTOM_SUBMIT_BUTTON = "model-provider-custom-submit-button";
