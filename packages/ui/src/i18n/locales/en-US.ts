...
const enUS: Record<string, string> = {
  ...
  "settings.modelProvider.customCreateTitle": "Create custom provider",
  "settings.modelProvider.templatePickerSearch": "Search providers",
  "settings.modelProvider.customCreate.catalogSearch": "Search providers",
  "settings.modelProvider.customCreate.catalog": "Provider",
  "settings.modelProvider.customCreate.catalogHint": "Selecting a provider matches the API format and Base URL and inherits its model settings. Choose \"Enter manually\" to fully customize.",
  "settings.modelProvider.customCreate.catalogManual": "Enter manually",
  "settings.modelProvider.customCreate.fetchModels": "Fetch models",
  "settings.modelProvider.customCreate.fetchedCount": "Fetched {count} models. Select the ones to add.",
  "settings.modelProvider.customCreate.inheritedSkipped": "Models already inherited from the provider are not listed",
  "settings.modelProvider.customCreate.submit": "Create",
  "settings.modelProvider.customCreate.fetchError.generic": "Failed to fetch models: {detail}",
  "settings.modelProvider.customCreate.fetchError.missing-base-url": "Enter a Base URL first",
  "settings.modelProvider.customCreate.fetchError.invalid-base-url": "Base URL is not a valid address",
  "settings.modelProvider.customCreate.fetchError.invalid-json": "Provider did not return JSON",
  "settings.modelProvider.customCreate.fetchError.unexpected-shape": "Unrecognized response shape",
  "settings.modelProvider.customCreate.fetchError.empty": "Provider returned no models",
  "settings.modelProvider.customCreate.fetchError.http-401": "Invalid API key (401)",
  "settings.modelProvider.customCreate.fetchError.http-403": "Access denied (403)",
  "settings.modelProvider.customCreate.fetchError.http-404": "This provider does not support listing models (404)",
  "settings.modelProvider.customCreate.fetchError.http-429": "Rate limited (429). Try again later",
  ...
  "settings.modelProvider.templatePickerEmpty": "No matching providers",
