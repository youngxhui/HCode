...
const zhCN: Record<string, string> = {
  ...
  "settings.modelProvider.customCreateTitle": "创建自定义供应商",
  "settings.modelProvider.templatePickerSearch": "搜索供应商",
  "settings.modelProvider.customCreate.catalogSearch": "搜索供应商",
  "settings.modelProvider.customCreate.catalog": "供应商",
  "settings.modelProvider.customCreate.catalogHint": "选择供应商可自动匹配 API 格式与 Base URL，并继承该供应商的模型参数；选择「手动填写」则完全自定义。",
  "settings.modelProvider.customCreate.catalogManual": "手动填写",
  "settings.modelProvider.customCreate.fetchModels": "自动拉取模型",
  "settings.modelProvider.customCreate.fetchedCount": "拉到 {count} 个模型，勾选要添加的模型",
  "settings.modelProvider.customCreate.inheritedSkipped": "供应商已继承的模型未在列表中显示",
  "settings.modelProvider.customCreate.submit": "创建",
  "settings.modelProvider.customCreate.fetchError.generic": "拉取模型失败：{detail}",
  "settings.modelProvider.customCreate.fetchError.missing-base-url": "请先填写 Base URL",
  "settings.modelProvider.customCreate.fetchError.invalid-base-url": "Base URL 不是合法地址",
  "settings.modelProvider.customCreate.fetchError.invalid-json": "供应商返回的不是 JSON",
  "settings.modelProvider.customCreate.fetchError.unexpected-shape": "无法识别的返回结构",
  "settings.modelProvider.customCreate.fetchError.empty": "供应商没有返回任何模型",
  "settings.modelProvider.customCreate.fetchError.http-401": "API Key 无效（401）",
  "settings.modelProvider.customCreate.fetchError.http-403": "没有访问权限（403）",
  "settings.modelProvider.customCreate.fetchError.http-404": "该供应商不支持列出模型（404）",
  "settings.modelProvider.customCreate.fetchError.http-429": "请求过于频繁（429），请稍后重试",
  ...
  "settings.modelProvider.templatePickerEmpty": "没有匹配的供应商",
